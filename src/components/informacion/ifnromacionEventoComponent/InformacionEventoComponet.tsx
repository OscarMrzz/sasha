...
import BotonCambioEstadoEvento from "@/components/informacion/ifnromacionEventoComponent/BotonCambioEstadoEvento";
import SeccionEquipoEvaluadorEvento from "@/components/informacion/ifnromacionEventoComponent/SeccionEquipoEvaluadorEvento";
