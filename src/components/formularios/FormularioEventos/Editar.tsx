...
import { registroEventoUpdateSchema } from "@/models/eventos/registroEventoSchema";
...
export default function FormularioEditarEventoComponet({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const parsed = registroEventoUpdateSchema.safeParse(nuevoEvento);
      if (!parsed.success) {
      ...
      await registoEvntoServices.update(EventoAEditar.idEvento,
        parsed.data as RegistroEventoInterface
      );
