    ...
    >
      ...
      <div className="shrink-0">
        <button
          ...
          className="rounded-md p-1 text-slate-400 transition-colors /80 hover:text-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primario)]"
        >
