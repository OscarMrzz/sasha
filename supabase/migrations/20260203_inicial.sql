...
CREATE POLICY "crear" ON "public"."bandas" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "crear" ON "public"."categorias" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid")))));



CREATE POLICY "crear" ON "public"."criteriosEvalucion" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "crear" ON "public"."perfiles" FOR INSERT WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))) AND ("idForaneaRol" <> '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid")));



CREATE POLICY "crear" ON "public"."regiones" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND (("per"."idForaneaRol" = '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid") OR ("per"."idForaneaRol" = '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid") OR ("per"."idForaneaRol" = 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"))))));



CREATE POLICY "crear" ON "public"."registroComentarios" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid"]))))));



CREATE POLICY "crear" ON "public"."registroCumplimientoEvaluaciones" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid"]))))));



CREATE POLICY "crear" ON "public"."respuestaSolicitudRevicion" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "crear" ON "public"."solicitudRevicion" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));
...
CREATE POLICY "editar" ON "public"."bandas" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."categorias" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."criteriosEvalucion" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."cumplimientos" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."federaciones" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid")))));



CREATE POLICY "editar" ON "public"."perfiles" FOR UPDATE USING (true) WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))) AND ("idForaneaRol" <> '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid")));



CREATE POLICY "editar" ON "public"."regiones" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND (("per"."idForaneaRol" = '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid") OR ("per"."idForaneaRol" = '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid") OR ("per"."idForaneaRol" = 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"))))));



CREATE POLICY "editar" ON "public"."registroComentarios" FOR UPDATE USING (true) WITH CHECK (false);



CREATE POLICY "editar" ON "public"."registroCumplimientoEvaluaciones" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."registroEquipoEvaluador" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."registroEventos" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."respuestaSolicitudRevicion" FOR UPDATE USING (true) WITH CHECK (false);



CREATE POLICY "editar" ON "public"."roles" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."rubricas" FOR UPDATE USING (true) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "editar" ON "public"."solicitudRevicion" FOR UPDATE USING (true) WITH CHECK (false);



CREATE POLICY "eliminar" ON "public"."bandas" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."categorias" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."criteriosEvalucion" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."cumplimientos" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."federaciones" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid")))));



CREATE POLICY "eliminar" ON "public"."perfiles" FOR DELETE USING (((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))) AND ("idForaneaRol" <> '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid")));



CREATE POLICY "eliminar" ON "public"."regiones" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."registroComentarios" FOR DELETE USING (false);



CREATE POLICY "eliminar" ON "public"."registroCumplimientoEvaluaciones" FOR DELETE USING (false);



CREATE POLICY "eliminar" ON "public"."registroEquipoEvaluador" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."registroEventos" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."respuestaSolicitudRevicion" FOR DELETE USING (false);



CREATE POLICY "eliminar" ON "public"."roles" FOR DELETE USING (false);



CREATE POLICY "eliminar" ON "public"."rubricas" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid"]))))));



CREATE POLICY "eliminar" ON "public"."solicitudRevicion" FOR DELETE USING (false);
...
CREATE POLICY "leer" ON "public"."bandas" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."categorias" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."criteriosEvalucion" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."cumplimientos" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."federaciones" FOR SELECT USING (true);
...
CREATE POLICY "leer" ON "public"."perfiles" FOR SELECT USING (true);



CREATE POLICY "leer" ON "public"."regiones" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND (("per"."idForaneaRol" = '49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid") OR ("per"."idForaneaRol" = '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid") OR ("per"."idForaneaRol" = 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid") OR ("per"."idForaneaRol" = '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid") OR ("per"."idForaneaRol" = 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid") OR ("per"."idForaneaRol" = '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid") OR ("per"."idForaneaRol" = 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"))))));



CREATE POLICY "leer" ON "public"."registroComentarios" FOR SELECT USING (true);



CREATE POLICY "leer" ON "public"."registroCumplimientoEvaluaciones" FOR SELECT USING (true);



CREATE POLICY "leer" ON "public"."registroEquipoEvaluador" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."registroEventos" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));
...
CREATE POLICY "leer" ON "public"."respuestaSolicitudRevicion" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."roles" FOR SELECT USING (true);
...
CREATE POLICY "leer" ON "public"."rubricas" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));



CREATE POLICY "leer" ON "public"."solicitudRevicion" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."perfiles" "per"
  WHERE (("per"."idForaneaUser" = "auth"."uid"()) AND ("per"."idForaneaRol" = ANY (ARRAY['49ec14ca-4d56-4922-8b51-0d98d16f5b0b'::"uuid", '9ea4730e-4ad2-482b-b28a-6eed64d33554'::"uuid", 'c5a2ec89-f1b2-4809-b3e2-26c121c7de1a'::"uuid", '3de63733-6c12-4d16-983d-e94642fa2bbf'::"uuid", 'f65337dd-2a4f-4d8a-afe0-0c3f4c503004'::"uuid", '47916180-ceb1-466a-8c52-745c4060acf5'::"uuid", 'c0f5f055-258f-4747-976e-d57abfb190db'::"uuid"]))))));
