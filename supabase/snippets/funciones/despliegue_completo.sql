-- =============================================================================
\
-- Orden: funciones -> permisos -> policies -> limpieza -> indices UNIQUE
-- =============================================================================

-- =============================================================================
-- FUNCIONES: evaluaciones duplicadas y panel Alertas
-- =============================================================================
-- IMPORTANTE: Si usas policies/indices por separado, ejecuta ESTE archivo ANTES.
-- Recomendado: pegar despliegue_completo.sql (incluye todo en orden correcto).
-- =============================================================================
