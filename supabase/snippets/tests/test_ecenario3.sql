...
/* ====================================================================== */
    ...
    INSERT INTO public."registroEquipoEvaluador" ("idRegistroEvaluador", "created_at", "idForaneaEvento", "idForaneaPerfil")
    VALUES
      (gen_random_uuid(), now(), idEventoASB, idPerfilResponsableBandas),
      (gen_random_uuid(), now(), idEventoPATRIA, idPerfilResponsableBandas),
      (gen_random_uuid(), now(), idEventoISA, idPerfilResponsableBandas),
      (gen_random_uuid(), now(), idEventoTECNO, idPerfilResponsableBandas),
      (gen_random_uuid(), now(), idEventoMBP, idPerfilResponsableBandas),
      (gen_random_uuid(), now(), idEventoASB, idPerfilResponsableUsuarios),
      (gen_random_uuid(), now(), idEventoPATRIA, idPerfilResponsableUsuarios),
      (gen_random_uuid(), now(), idEventoISA, idPerfilResponsableUsuarios),
      (gen_random_uuid(), now(), idEventoTECNO, idPerfilResponsableUsuarios),
      (gen_random_uuid(), now(), idEventoMBP, idPerfilResponsableUsuarios),
      (gen_random_uuid(), now(), idEventoASB, idPerfilResponsableEventos),
      (gen_random_uuid(), now(), idEventoPATRIA, idPerfilResponsableEventos),
      (gen_random_uuid(), now(), idEventoISA, idPerfilResponsableEventos),
      (gen_random_uuid(), now(), idEventoTECNO, idPerfilResponsableEventos),
      (gen_random_uuid(), now(), idEventoMBP, idPerfilResponsableEventos),
      (gen_random_uuid(), now(), idEventoASB, idPerfilResponsableMesa),
      (gen_random_uuid(), now(), idEventoPATRIA, idPerfilResponsableMesa),
      (gen_random_uuid(), now(), idEventoISA, idPerfilResponsableMesa),
      (gen_random_uuid(), now(), idEventoTECNO, idPerfilResponsableMesa),
      (gen_random_uuid(), now(), idEventoMBP, idPerfilResponsableMesa);
